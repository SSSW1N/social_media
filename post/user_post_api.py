...
from database.postservice import get_all_posts_db, get_exact_post_db, add_post_db, add_post_photo_db, delete_post_db, edit_post_db
...
async def add_photo(post_id: int = Body(),
    ...
    try:
        # Сохранение фотографий в папку медиа
        ...
        result = add_post_photo_db(post_id=post_id, photo=photo_path)
